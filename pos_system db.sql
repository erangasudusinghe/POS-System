...
(15, 13, 3, 'Anju', 1, 100, 'Paid With Discount', 10);
...
INSERT INTO `supplier` (`SupplierID`, `SupplierName`, `ProductsID`, `ProductName`, `Quntity`, `UnitPrice`, `TotalPrice`) VALUES
(1004, 'Saniru', '1', 'Cream Cracker', 56, 0, 0),
(1005, 'Eranga', '12', 'Munchi LemonPuff', 10, 45, 450);
...
INSERT INTO `users` (`Type`, `Name`, `Password`, `state`) VALUES
('Admin', 'Eranga', '1234qwer', 1);
...
--
ALTER TABLE `sales`
  MODIFY `SaleID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
COMMIT;
